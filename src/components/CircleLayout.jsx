    ...
    <div className="start-page">
      <svg width="800" height="800" viewBox="0 0 800 800" className="circle-layout">
        ...
        <a href="/register" className="circle-button">
          ...
          <text>
            <textPath href="#path-register" startOffset="5%" text-anchor="middle">Register</textPath>
          </text>
        </a>
        ...
        <a href="/impressum" className="circle-button">
          ...
          <text>
            <textPath href="#path-impressum" startOffset="60%" text-anchor="middle">Impressum</textPath>
          </text>
        </a>
        ...
        <a href="/about-us" className="circle-button">
          ...
          <text>
            <textPath href="#path-about-us" startOffset="40%" text-anchor="middle">About Us</textPath>
          </text>
        </a>
        ...
        <a href="/login" className="circle-button">
          ...
          <text>
            <textPath href="#path-login" startOffset="90%" text-anchor="middle">Login</textPath>
          </text>
        </a>
      </svg>
    </div>
